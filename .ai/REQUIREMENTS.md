...
| R-BAT-8 | Works with local company sites and relative links | 21 | todo |  |  |
...
| R-SEC-1 | Validate external URLs and reject private and loopback addresses in production | 20 | todo |  |  |
